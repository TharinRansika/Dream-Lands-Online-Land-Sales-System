...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../css/Sign-In Page Styles.css">
</head>
    ...
    <!---------------------------------          header        ---------------------------------------->
            <div class="header">
                ...
                <div class="navigation-buttons">
                    ...
                    <a href="../html/Account Page.html" ><input class="nav-button" type="button" value="ACCOUNT" id="account-button"></a>
    ...
    <!-------------------------------            content         ----------------------------------------->
            <div class="content">
                 <div class="sign-in-portal">
                     <form class="sign-in-form"  method="post" action="Action Sign-In Page.php">
                         <div class="sign-in-header">
                             <p>SIGN-IN</p>
                         </div>
                         <input class="sign-in-input" type="email"  placeholder="Enter E-mail Address" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
                         <input class="sign-in-input" type="password" placeholder="Enter Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Password must contain at least 8 characters with digits and spacial characters" required >
                         <input class="submit-button" type="submit" value="SUBMIT" name="subButton">
                     </form>
                 </div>
            </div>
