...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="../css/Admin Page Styles.css">
</head>
...
<!-------------------------------            content         ----------------------------------------->
        <div class="content">
            <div class="admin-page-header">
                WELCOME &nbsp<?php  echo "<span>" .$_SESSION['Name']."</span>"; ?>&nbsp TO ADMIN PAGE
            </div>
            <div class="sub-content">
                <div class="admin-portal">
                    <a href="Check Land Details.php"><button class="admin-button">CHECK LAND DETAILS</button></a>
                    <a href="Add New Lands.php"><button class="admin-button">ADD NEW LANDS</button></a>
                    <a href="Update Land Details.php"><button class="admin-button">UPDATE LAND DETAILS</button></a>
                    <a href="Delete Land Details.php"><button class="admin-button">DELETE LAND DETAILS</button></a>
                    <a href="#"><button class="admin-button">CHECK CUSTOMER INQUIRIES</button></a>
                    <a href="#"><button class="admin-button">CHECK CUSTOMER UPLOADED LAND DETAILS</button></a> 
                </div>
            </div>
        </div>
